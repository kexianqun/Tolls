...
<body>
	...
	<div class="appointment-w3" align="center">
		<form id="login_form" action="#" method="post">
			<div class="personal">
				...
				<div class="main">
					<div class="formNew">
                        ...
                        <tr>
                         <td>用户名：</td>
                         <td><input type="text" class="top-up" id="username" name="username" placeholder="username" required=""></td>
                        </tr>
                        <tr>
                         <td>密码：</td>
                         <td widtth="230"><input type="password" class="top-up" id="password" name="password" placeholder="password" required=""></td>
                        </tr>
			...
			<div class="btnn">
				<input id="save" type="button" value="登陆" onclick="login()"><br>
				<a href="../user/register.jsp">我要注册</a>
			</div>
			</div>
		</form>
	</div>
